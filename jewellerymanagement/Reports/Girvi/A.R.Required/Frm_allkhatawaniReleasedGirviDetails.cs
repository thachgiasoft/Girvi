...
{
    public partial class Frm_allkhatawaniReleasedGirviDetails : Form
    {
        ...
        public Frm_allkhatawaniReleasedGirviDetails()
        {
            InitializeComponent();
        }
        ...
        private void bttn_View_Click(object sender, EventArgs e)
        {
            ...
            dgv_girvidetails.Rows.Add("","", "", "", "", "Total", SumNaveAmount, "", "", "Total", sumamount, "");
        ...
        private void bttn_reset_Click(object sender, EventArgs e)
        {
            ...
            //clsVariable.ReportType = "KhatawaniWithReleaseGirvi";
        ...
        private void Frm_allkhatawaniReleasedGirviDetails_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dtkhatawani.Rows.Count; i++)
            {
                ...
                dtGirvi = _objKhatwaniWithGirviBal.getallReleasegirvidata(khatawani_no, dtp_StartDate.Text, dtp_EndDate.Text);
                dtkhatawniDetails = _objKhatwaniWithGirviBal.getkhatawanidetail(khatawani_no);
        ...
        private void bttn_Print_Click(object sender, EventArgs e)
        {
            ...
            SendData _obj = new SendData(_objfrm_ReportViewer.ReceiveDataAllKhatawaniReleaseGirviDetails);
        ...
        private void rbt_Hindi_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lbl_Date.Text = "तारीख";
            this.Text = "खतावणीसे जुडी गिरवी छुटी हुई";
            ...
            dgv_girvidetails.Columns["datejama"].HeaderText = "सोडवण्याची तारीख";
            dgv_girvidetails.Columns["muddaljama"].HeaderText = "सोडवण्याची रक्कम";
            ...
            dgv_girvidetails.Columns["muddalbaki"].HeaderText = "मुद्दल";
             dgv_girvidetails.Columns["vyajbaki"].HeaderText = "एकूण";
             dgv_girvidetails.Columns["ekunbaki"].HeaderText = "";
             dgv_girvidetails.Columns["shera"].HeaderText = "एकूण";
             //dgv_girvidetails.Columns["receipt_no"].HeaderText = "पावती क्र.";
        ...
        private void rbt_Marathi_CheckedChanged(object sender, EventArgs e)
        {
            ...
            grp_Date.Text = "दिनांक";
            lbl_Date.Text = "तारीख";
            this.Text = "खातावनीशी संबंधित गाहनी सोडवलेली";
            lbl_StartDate.Text = "शुरवात तारीख";
            lbl_EndDate.Text = "अंतिम तारीख";
        ...
        private void Frm_allkhatawaniReleasedGirviDetails_Load(object sender, EventArgs e)
        {
