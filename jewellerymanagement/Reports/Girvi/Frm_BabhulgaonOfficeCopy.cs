...
{
    public partial class Frm_BabhulgaonOfficeCopy : Form
    {
        Validation _objValidation = new Validation();
        cls_GirviAdd _objGirviAdd = new cls_GirviAdd();
        Validation val = new Validation();
        public delegate void SendData(string BillNO, string AccNo, string otherFont, string printer);
        public delegate void SendDataSingle(string BillNO, string AccNo, string otherFont);

        public Frm_BabhulgaonOfficeCopy()
        {
            InitializeComponent();
        }
        ...
        private void bttn_login_Click(object sender, EventArgs e)
        {
            if (oPrintersetting.ShowDialog() == DialogResult.OK)
            {
                if (rbt_OtherTrue.Checked == true)
                {
                    ...
                    SendData _obj = new SendData(_objfrm_ReportViewer.ReceiveBabhulgaonOfficeCopy);
            ...
            //{
            //    CrystalReport.frm_ReportViewer _objfrm_ReportViewer = new CrystalReport.frm_ReportViewer();
            //    SendDataSingle _obj = new SendDataSingle(_objfrm_ReportViewer.ReceiveDataAddGirvi);
